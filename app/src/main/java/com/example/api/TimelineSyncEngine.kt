...
object TimelineSyncEngine {
    ...
    fun calculateAccumulatedFocusMs(timeline: List<TimelineEvent>, currentStatus: String): Long {
        ...
        val isIdleOrRelaxing = cleanStatus == "relaxing" || cleanStatus == "idle" || cleanStatus.isEmpty()

        if (isIdleOrRelaxing) {
            return 0L
        }

        val isLiveFocusing = cleanStatus.contains("focus") || cleanStatus.contains("study") || cleanStatus.contains("work") || cleanStatus == "running"
